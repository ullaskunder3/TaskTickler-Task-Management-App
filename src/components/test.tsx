...
const DATA = [
  {
    ...
    name: "Added",
    items: [
      { id: "26fd50b3-3841-496e-8b32-73636f6f4197", name: "3% Milk", priority: "high" },
      { id: "b0ee9d50-d0a6-46f8-96e3-7f3f0f9a2525", name: "Butter", priority: "medium" },
    ],
    tint: 1,
  },
  {
    ...
    items: [
      ...
      { id: "5bee94eb-6bde-4411-b438-1c37fa6af364", name: "Atomic Habits", priority: "low" },
    ],
    tint: 2,
  },
  {
    ...
    name: "Completed",
    items: [
      { id: "960cbbcf-89a0-4d79-aa8e-56abbc15eacc", name: "Workbench", priority: "medium" },
      { id: "d3edf796-6449-4931-a777-ff66965a025b", name: "Hammer", priority: "low" },
    ],
    tint: 3,
  },
];
